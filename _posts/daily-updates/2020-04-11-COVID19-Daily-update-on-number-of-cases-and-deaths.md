...
- Global: 1,653,204 total cases, and 102,088 deaths in 206 countries with reported COVID-19 cases.

- EU28: 719,880 cases, and 68,068 deaths.

- Belgium: 27,540 total cases, 5,635 total hospitalised, 1,262 in intensive care, 3,346 deceased, and 5,986 recovered.
...
There are currently 27,540 confirmed infections, 5,635 hospitalized patients, 1,262 patients in intensive care, with 981 patients on respiratory aid, and 3,346 people have died from the infection.
On the up side, 5,986 patients have been released from the hospital. There is a current maximum capacity of 2,293 ICU beds reserved for COVID patients, and 55.04% of capacity of ICU beds is taken.

{% include plots/daily-update-2020-04-11/2020-04-11-Belgium-cumulative.html %}
...
{% include plots/daily-update-2020-04-11/2020-04-11-Belgium-province.html %}

<p style="text-align: center; font-style: italic;">Figure 2: Number of cases and hospitalizations by province.</p>

Figure 3 shows the number of cases by municipality.[^3] The city with the highest number of infections is Antwerpen with 1,032. Liège follows with 593 and Mons is third with 438 cases.
...
{% include plots/daily-update-2020-04-11/2020-04-11-Belgium-life-expectancy.html %}
...
The results are informative: under the assumption that Belgium has reached its first peak (around 40 days), it seems it will complete its cycle at a slower rate than China (peak at around 20-25 days), conditional on having 
other factors being the same (lockdown policies, population density and heterogeneity etc). 
However, also for China we observe the potential onset of a second wave. We compare cases and deaths over time as the outbreak evolves, and we re-estimate, fit and update these curves daily.
...
{% include plots/daily-update-2020-04-11/2020-04-11-MA_ln_share_cases-midpoint-Belgium.html %}
...
Figure 6 shows the total number of cases over time. The country with the most cases is United States of America with 501,560 total confirmed cases. Second is Spain with 157,022 cases, and Italy follows, with 147,577 cases.
...
When looking at the EU28, the country with the most cases is Spain with 157,022 total confirmed cases.
Second is Italy, with 147,577 confirmed cases, and Germany follows, with 117,658 cases.
...
However, we expect the measurement error to be smaller for the reported number of deaths. As of today, the country with the most deaths is Italy, with 18,851 deaths.
Second is United States of America, with 18,777 deaths, and Spain follows, with 15,843 deaths.
...
The EU28 country with the most deaths is Italy, with 18,851 deaths. Second is Spain, with 15,843 deaths, and France follows, with 13,197 deaths.

{% include plots/daily-update-2020-04-11/2020-04-11-ln_cum_cases-ln_cum_deaths-after_10th.html %}
...
{% include plots/daily-update-2020-04-11/2020-04-11-cum_cases_population-cum_deaths_population-after_0.001.html %}
...
{% include plots/daily-update-2020-04-11/2020-04-11-policy.html %}
...
{% include plots/daily-update-2020-04-11/2020-04-11-MA_cases-MA_deaths-after_100th.html %}
...
{% include plots/daily-update-2020-04-11/2020-04-11-MA_ln_share_cases-MA_ln_share_deaths-midpoint.html %}
