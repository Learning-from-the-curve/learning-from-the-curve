...
- **Global:** 3,623,803 total cases, and 256,880 deaths in 209 countries with reported COVID-19 cases.
- **EU28:** 1,176,326, and 139,530 deaths.
- **Belgium:** 49,671 total cases, 2,849 total hospitalised, 646 in intensive care, 8,339 deceased, and 12,731 recovered.
...
There are currently 49,671 confirmed infections, 2,849 hospitalized patients, 646 patients in intensive care, with 362 patients on respiratory aid, and 8,339 people have died from the infection. On the up side, 12,731 patients have been released from the hospital. There is a current maximum capacity of 2,293 ICU beds reserved for COVID-19 patients, and 28.17% of capacity of ICU beds is taken.
...
{% include plots/daily-update-2020-05-06/2020-05-06-Belgium-cumulative.html %}
...
{% include plots/daily-update-2020-05-06/2020-05-06-Belgium-province.html %}

<p style="text-align: center; font-style: italic;">Figure 2: Number of cases and hospitalizations by province.</p>

Next, Figure 3 shows the number of cases by municipality.[^3] The city with the highest number of infections is currently Antwerpen with 1,977. Liège follows with 1,153 and Anderlecht is third with 776 cases.
...
{% include plots/daily-update-2020-05-06/2020-05-06-Belgium-map.html %}
...
{% include plots/daily-update-2020-05-06/2020-05-06-Belgium-average-deaths.html %}
...
{% include plots/daily-update-2020-05-06/2020-05-06-Belgium-life-expectancy.html %}
...
{% include plots/daily-update-2020-05-06/2020-05-06-MA_ln_share_cases-midpoint-Belgium.html %}
...
When looking at the EU28, the country with the most cases is Spain with 219,329 total confirmed cases. Second is Italy, with 213,013 confirmed cases, and United Kingdom follows, with 194,990 cases. It's worth noting that Sweden's infection rate has decreased significantly since around the 9th day after the 100th confirmed case, while having a [more lenient policy](https://www.forbes.com/sites/davidnikel/2020/03/30/why-swedens-coronavirus-approach-is-so-different-from-others/#538677cb562b).  

The Figure also reports the total number of deaths since the 10th death. As noted in the introduction, both the number of cases and deaths are prone to several sources of non-random measurement error. However, we expect the measurement error to be smaller for the reported number of deaths. As of today, the country with the most deaths is United States of America, with 71,078 deaths. Second is United Kingdom, with 29,427 deaths, and Italy follows, with 29,315 deaths. These top 3 countries account for 50.54% of all deaths worldwide. Again, we see that China has stabilized for now, with around 3,500 deaths. We repeat the graph for the 10 highest mortality countries in the EU28. The EU28 country with the most deaths is United Kingdom, with 29,427 deaths. Second is Italy, with 29,315 deaths, and Spain follows, with 25,613 deaths.

{% include plots/daily-update-2020-05-06/2020-05-06-ln_cum_cases-ln_cum_deaths-after_10th.html %}
...
{% include plots/daily-update-2020-05-06/2020-05-06-policy.html %}
...
{% include plots/daily-update-2020-05-06/2020-05-06-MA_cases-MA_deaths-after_100th.html %}
...
{% include plots/daily-update-2020-05-06/2020-05-06-MA_ln_share_cases-MA_ln_share_deaths-midpoint.html %}
