...
- **Global:** 2,355,853 total cases, and 164,656 deaths in 206 countries with reported COVID-19 cases.
- **EU28:** 938,772 cases and 99,068 deaths.
- **Belgium:** 39,357 total cases, 4,920 total hospitalised, 1,071 in intensive care, 5,828 deceased, and 8,894 recovered.
...
There are currently 39,357 confirmed infections, 4,920 hospitalized patients, 1,071 patients in intensive care, with 760 patients on respiratory aid, and 5,828 people have died from the infection. On the up side, 8,894 patients have been released from the hospital. There is a current maximum capacity of 2,293 ICU beds reserved for COVID-19 patients, and 46.71% of capacity of ICU beds is taken.
...
{% include plots/daily-update-2020-04-20/2020-04-20-Belgium-cumulative.html %}
...
{% include plots/daily-update-2020-04-20/2020-04-20-Belgium-province.html %}

<p style="text-align: center; font-style: italic;">Figure 2: Number of cases and hospitalizations by province.</p>

Next, Figure 3 shows the number of cases by municipality.[^3] The city with the highest number of infections is currently Antwerpen with 1,375. Liège follows with 954 and Brussel is third with 595 cases.
...
{% include plots/daily-update-2020-04-20/2020-04-20-Belgium-average-deaths.html %}
...
{% include plots/daily-update-2020-04-20/2020-04-20-Belgium-life-expectancy.html %}
...
{% include plots/daily-update-2020-04-20/2020-04-20-MA_ln_share_cases-midpoint-Belgium.html %}
...
When looking at the EU28, the country with the most cases is Spain with 195,944 total confirmed cases. Second is Italy, with 178,972 confirmed cases, and Germany follows, with 141,672 cases. It's worth noting that Sweden's infection rate has decreased significantly since around the 9th day after the 100th confirmed case, while having a [more lenient policy](https://www.forbes.com/sites/davidnikel/2020/03/30/why-swedens-coronavirus-approach-is-so-different-from-others/#538677cb562b).  

The Figure also reports the total number of deaths since the 10th death. As noted in the introduction, both the number of cases and deaths are prone to several sources of non-random measurement error. However, we expect the measurement error to be smaller for the reported number of deaths. As of today, the country with the most deaths is United States of America, with 40,682 deaths. Second is Italy, with 23,660 deaths, and Spain follows, with 20,453 deaths. These top 3 countries account for 51.50% of all deaths worldwide. Again, we see that China has stabilized for now, with around 3,500 deaths. We repeat the graph for the 10 highest mortality countries in the EU28. The EU28 country with the most deaths is Italy, with 23,660 deaths. Second is Spain, with 20,453 deaths, and France follows, with 19,718 deaths.

{% include plots/daily-update-2020-04-20/2020-04-20-ln_cum_cases-ln_cum_deaths-after_10th.html %}
...
{% include plots/daily-update-2020-04-20/2020-04-20-policy.html %}
...
{% include plots/daily-update-2020-04-20/2020-04-20-MA_cases-MA_deaths-after_100th.html %}
...
{% include plots/daily-update-2020-04-20/2020-04-20-MA_ln_share_cases-MA_ln_share_deaths-midpoint.html %}
