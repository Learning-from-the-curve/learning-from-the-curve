...
- **Global:** 2,914,507 total cases, and 205,923 deaths in 207 countries with reported COVID-19 cases.
- **EU28:** 1,062,156, and 118,275 deaths.
- **Belgium:** 45,685 total cases, 3,968 total hospitalised, 903 in intensive care, 7,207 deceased, and 10,878 recovered.
...
There are currently 45,685 confirmed infections, 3,968 hospitalized patients, 903 patients in intensive care, with 600 patients on respiratory aid, and 7,207 people have died from the infection. On the up side, 10,878 patients have been released from the hospital. There is a current maximum capacity of 2,293 ICU beds reserved for COVID-19 patients, and 39.38% of capacity of ICU beds is taken.
...
{% include plots/daily-update-2020-04-27/2020-04-27-Belgium-cumulative.html %}
...
{% include plots/daily-update-2020-04-27/2020-04-27-Belgium-province.html %}

<p style="text-align: center; font-style: italic;">Figure 2: Number of cases and hospitalizations by province.</p>

Next, Figure 3 shows the number of cases by municipality.[^3] The city with the highest number of infections is currently Antwerpen with 1,683. Liège follows with 1,105 and Brussel is third with 687 cases.
...
{% include plots/daily-update-2020-04-27/2020-04-27-Belgium-average-deaths.html %}
...
{% include plots/daily-update-2020-04-27/2020-04-27-Belgium-life-expectancy.html %}
...
{% include plots/daily-update-2020-04-27/2020-04-27-MA_ln_share_cases-midpoint-Belgium.html %}
...
When looking at the EU28, the country with the most cases is Spain with 207,634 total confirmed cases. Second is Italy, with 197,675 confirmed cases, and Germany follows, with 155,193 cases. It's worth noting that Sweden's infection rate has decreased significantly since around the 9th day after the 100th confirmed case, while having a [more lenient policy](https://www.forbes.com/sites/davidnikel/2020/03/30/why-swedens-coronavirus-approach-is-so-different-from-others/#538677cb562b).  

The Figure also reports the total number of deaths since the 10th death. As noted in the introduction, both the number of cases and deaths are prone to several sources of non-random measurement error. However, we expect the measurement error to be smaller for the reported number of deaths. As of today, the country with the most deaths is United States of America, with 54,876 deaths. Second is Italy, with 26,644 deaths, and Spain follows, with 23,190 deaths. These top 3 countries account for 50.85% of all deaths worldwide. Again, we see that China has stabilized for now, with around 3,500 deaths. We repeat the graph for the 10 highest mortality countries in the EU28. The EU28 country with the most deaths is Italy, with 26,644 deaths. Second is Spain, with 23,190 deaths, and France follows, with 22,856 deaths.

{% include plots/daily-update-2020-04-27/2020-04-27-ln_cum_cases-ln_cum_deaths-after_10th.html %}
...
{% include plots/daily-update-2020-04-27/2020-04-27-cum_cases_population-cum_deaths_population-after_0.001.html %}
...
{% include plots/daily-update-2020-04-27/2020-04-27-policy.html %}
...
{% include plots/daily-update-2020-04-27/2020-04-27-MA_cases-MA_deaths-after_100th.html %}
...
{% include plots/daily-update-2020-04-27/2020-04-27-MA_ln_share_cases-MA_ln_share_deaths-midpoint.html %}
