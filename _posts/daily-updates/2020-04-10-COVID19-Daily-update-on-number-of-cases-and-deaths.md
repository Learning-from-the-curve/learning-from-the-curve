...
- Global: 1,563,857 total cases, and 95,044 deaths in 206 countries with reported COVID-19 cases.

- EU28: 689,845, and 63,915 deaths.

- Belgium: 26,198 total cases, 5,610 total hospitalised, 1,278 in intensive care, 3,019 deceased, and 5,568 recovered.
...
There are currently 26,198 confirmed infections, 5,610 hospitalized patients, 1,278 patients in intensive care, with 993 patients on respiratory aid, and 3,019 people have died from the infection.
On the up side, 5,568 patients have been released from the hospital. There is a current maximum capacity of 2,293 ICU beds reserved for COVID patients, and 55.73% of capacity of ICU beds is taken.

{% include plots/daily-update-2020-04-10/2020-04-10-Belgium-cumulative.html %}
...
{% include plots/daily-update-2020-04-10/2020-04-10-Belgium-province.html %}

<p style="text-align: center; font-style: italic;">Figure 2: Number of cases and hospitalizations by province.</p>

Figure 3 shows the number of cases by municipality.[^3] The city with the highest number of infections is Antwerpen with 988. Liège follows with 560 and Mons is third with 432 cases.
...
{% include plots/daily-update-2020-04-10/2020-04-10-Belgium-life-expectancy.html %}
...
{% include plots/daily-update-2020-04-10/2020-04-10-MA_ln_share_cases-midpoint-Belgium.html %}
...
Figure 6 shows the total number of cases over time. The country with the most cases is United States of America with 466,033 total confirmed cases. Second is Spain with 152,446 cases, and Italy follows, with 143,626 cases.
...
When looking at the EU28, the country with the most cases is Spain with 152,446 total confirmed cases.
Second is Italy, with 143,626 confirmed cases, and Germany follows, with 113,525 cases.
...
However, we expect the measurement error to be smaller for the reported number of deaths. As of today, the country with the most deaths is Italy, with 18,281 deaths.
Second is United States of America, with 16,690 deaths, and Spain follows, with 15,238 deaths.
These top 3 countries account for 0.53% of all deaths worldwide. Again, we see that China has stabilized for now, with around 3,500 deaths. We repeat the graph for the 10 highest mortality countries in the EU28.
The EU28 country with the most deaths is Italy, with 18,281 deaths. Second is Spain, with 15,238 deaths, and France follows, with 12,210 deaths.

{% include plots/daily-update-2020-04-10/2020-04-10-ln_cum_cases-ln_cum_deaths-after_10th.html %}
...
As of today, the EU28 has an average infection rate of 0.135%, and a mortality rate of 0.012%, calculated as the total number of cases/deaths over the EU28 population. This is still far off the [projections](https://www.hsph.harvard.edu/news/hsph-in-the-news/the-latest-on-the-coronavirus/) of 30-70% of adult world population ultimately being infected.  There are at least four hypotheses:
...
{% include plots/daily-update-2020-04-10/2020-04-10-cum_cases_population-cum_deaths_population-after_0.001.html %}
...
{% include plots/daily-update-2020-04-10/2020-04-10-policy.html %}
...
{% include plots/daily-update-2020-04-10/2020-04-10-MA_cases-MA_deaths-after_100th.html %}
...
{% include plots/daily-update-2020-04-10/2020-04-10-MA_ln_share_cases-MA_ln_share_deaths-midpoint.html %}
