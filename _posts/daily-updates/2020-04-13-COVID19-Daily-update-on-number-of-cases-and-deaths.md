...
The results are informative: if Belgium is near its peak, it seems to take longer (roughly 40 days) to reach it than China (around 25-30 days). If the shape of the trajectory is similar, this might imply that Belgium faces a longer cycle overall than China, conditional on the current policies implemented. However, also for China we observe the potential onset of a second wave. We compare cases and deaths over time as the outbreak evolves, and we re-estimate, fit and update these curves daily.
...
{% include plots/daily-update-2020-04-13/2020-04-13-ln_cum_cases-ln_cum_deaths-after_10th.html %}
...
The index is [The Oxford COVID-19 Government Response Tracker](https://www.bsg.ox.ac.uk/research/research-projects/oxford-covid-19-government-response-tracker),[^8] ranges between 0 (no policy) to 100 (maximum measures) and combines 11 indicators of government responses, including school closures, travel bans, and fiscal or monetary measures.
