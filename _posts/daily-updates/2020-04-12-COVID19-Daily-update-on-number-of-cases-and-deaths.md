...
- Global: 1,734,913 total cases, and 108,306 deaths in 206 countries with reported COVID-19 cases.

- EU28: 750,681, and 71,557 deaths.

- Belgium: 29,147 total cases, 5,353 total hospitalised, 1,223 in intensive care, 3,600 deceased, and 6,463 recovered.
...
There are currently 29,147 confirmed infections, 5,353 hospitalized patients, 1,223 patients in intensive care, with 930 patients on respiratory aid, and 3,600 people have died from the infection.
On the up side, 6,463 patients have been released from the hospital. There is a current maximum capacity of 2,293 ICU beds reserved for COVID patients, and 53.34% of capacity of ICU beds is taken.

{% include plots/daily-update-2020-04-12/2020-04-12-Belgium-cumulative.html %}
...
{% include plots/daily-update-2020-04-12/2020-04-12-Belgium-province.html %}

<p style="text-align: center; font-style: italic;">Figure 2: Number of cases and hospitalizations by province.</p>

Figure 3 shows the number of cases by municipality.[^3] The city with the highest number of infections is Antwerpen with 1,064. Liège follows with 646 and Brussel is third with 452 cases.
...
{% include plots/daily-update-2020-04-12/2020-04-12-Belgium-life-expectancy.html %}
...
{% include plots/daily-update-2020-04-12/2020-04-12-MA_ln_share_cases-midpoint-Belgium.html %}
...
Figure 6 shows the total number of cases over time. The country with the most cases is United States of America with 529,951 total confirmed cases. Second is Spain with 161,852 cases, and Italy follows, with 152,271 cases.
...
When looking at the EU28, the country with the most cases is Spain with 161,852 total confirmed cases.
Second is Italy, with 152,271 confirmed cases, and Germany follows, with 120,479 cases.
...
However, we expect the measurement error to be smaller for the reported number of deaths. As of today, the country with the most deaths is United States of America, with 20,608 deaths.
Second is Italy, with 19,470 deaths, and Spain follows, with 16,353 deaths.
...
The EU28 country with the most deaths is Italy, with 19,470 deaths. Second is Spain, with 16,353 deaths, and France follows, with 13,832 deaths.

{% include plots/daily-update-2020-04-12/2020-04-12-ln_cum_cases-ln_cum_deaths-after_10th.html %}
...
As of today, the EU28 has an average infection rate of 0.146%, and a mortality rate of 0.014%, calculated as the total number of cases/deaths over the EU28 population. This is still far off the [projections](https://www.hsph.harvard.edu/news/hsph-in-the-news/the-latest-on-the-coronavirus/) of 30-70% of adult world population ultimately being infected.  There are at least four hypotheses:
...
{% include plots/daily-update-2020-04-12/2020-04-12-cum_cases_population-cum_deaths_population-after_0.001.html %}
...
{% include plots/daily-update-2020-04-12/2020-04-12-policy.html %}
...
{% include plots/daily-update-2020-04-12/2020-04-12-MA_cases-MA_deaths-after_100th.html %}
...
{% include plots/daily-update-2020-04-12/2020-04-12-MA_ln_share_cases-MA_ln_share_deaths-midpoint.html %}
